...
const Hero = () => {
  ...
  return (
    <div className="w-full bg-[var(--primary-green-cold)] text-white pt-12 pb-40 md:py-16 mb-52 md:mb-38">
      <div className="hero-layout flex items-center justify-center relative md:justify-between lg:max-w-7xl mx-auto px-2">
        ...
        <div
          className="hero-image flex items-center justify-center absolute left-1/2 -translate-x-1/2 bottom-[-22rem] 
                     md:w-[40%] md:bottom-0 md:left-auto md:translate-x-0 md:right-[10%]
                     lg:right-[5%] lg:top-40 lg:w-auto"
        >
          <img
            src={heroImage}
            alt="A plated Mediterranean dish from Little Lemon restaurant"
          />
        </div>
      </div>
    </div>
