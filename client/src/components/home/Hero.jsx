...
const Hero = () => {
  ...
  return (
    <section className="w-full bg-[var(--primary-green-cold)]  text-white pt-12 pb-40 md:py-16 mb-52 md:mb-38">
      <div className="hero-layout flex items-center justify-center relative md:justify-between lg:max-w-7xl mx-auto px-4">
        <div className="hero-text max-w-sm space-y-1 md:space-y-6 flex flex-col items-center md:items-start">
          <h1 className="text-5xl font-semibold text-[60px] md:text-[84px] text-[var(--secondary-btn)]">
            Little Lemon
          </h1>
          <h2 className="text-3xl font-semibold md:text-[56px] text-[36px] ">
            Chicago
          </h2>
          <p className="text-lg text-[16px] md:text-[22px] tracking-[1%] text-center md:text-start py-2">
        ...
        <div className="hero-image flex items-center justify-center ">
          ...
          <img
            ...
            alt="hero"
            className="
              absolute left-1/2 -translate-x-1/2 bottom-[-22rem] w-[60%]

              md:static md:translate-x-0 md:left-auto md:bottom-auto md:w-[65%] lg:w-[85%]"
          />
        </div>
      </div>
    </section>
